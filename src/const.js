...
const ValidityError = {
  ...
  DISABLED_START_DATE: `Дата начала события не должна быть внутри другого события`,
  DISABLED_FINISH_DATE: `Дата окончания события не должна быть внутри другого события`,
